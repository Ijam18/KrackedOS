...
> This MAJI instance now lives inside the broader `krack/` architecture.
>
> Canonical entry sequence:
> `krack/index/master-majios.md` → `krack/core/maji/master-memory.md` → `krack/system/IJAM_UNIFIED.md`
