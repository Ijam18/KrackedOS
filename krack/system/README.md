...
Adapter note:
- `krack/skills/local-skills/` is the canonical repo-owned skill source
- `.agents/skills/` and optional `.claude/skills/` are tool execution surfaces
- `tools/Kracked_Skills_Agent-main/` is an optional external tooling bundle with a documented bridge into krack doctrine
