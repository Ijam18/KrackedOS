...
This is the canonical skills index inside `krack/`.

Adapter surfaces:
- `.agents/skills/` is the Codex-native installed target
- `.claude/skills/` is optional for Claude-native installs
...
-   **krack/system/SkillCreator.md**: Advanced guide for building skills.
...
*File: `krack/skills/local-skills/moon-builder-proxy/SKILL.md`*
...
- load `krack/system/IJAM_UNIFIED.md`
- run a memory sweep through `krack/engine/memory/log.md`
- review relevant skills in `krack/skills/local-skills/`
