...
- Key files updated:
  - `krack/core/maji/main/identity-core.md`
  - `krack/core/maji/main/relationship-memory.md`
  - `krack/system/IJAM_UNIFIED.md`

### 2. Memory Path Alignment
- Cleaned up stale references to `engine/memory/memory/...` across the active krack startup and skill documentation.
- The canonical repo path is now consistently treated as `krack/engine/memory/`.
- Key files updated:
  - `krack/system/IJAM_UNIFIED.md`
  - `krack/index/activation-protocol.md`
  - `krack/skills/local-skills/moon-builder-proxy/SKILL.md`
  - `krack/system/skills_documentation.md`
...
- Key file updated:
  - `krack/core/maji/main/current-session.md`
