...
1. Read [`krack/system/IJAM_UNIFIED.md`](../../../system/IJAM_UNIFIED.md).
2. Read [`krack/engine/memory/log.md`](../../../engine/memory/log.md) and the latest dated memory note if one exists.
3. Review relevant local skills in [`krack/skills/local-skills/`](..).
...
- Read long-term context from `krack/engine/memory/log.md`
- Check recent dated notes in `krack/engine/memory/YYYY-MM-DD.md` when available
...
2. Read persistent context from `krack/engine/memory/log.md` and latest daily note if present.
...
- `krack/system/IJAM_UNIFIED.md`
- `krack/engine/memory/log.md`
...
- `krack/engine/memory/engine/memory-extract/`
