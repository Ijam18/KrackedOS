    ...
    constructor() {
        ...
        this.LOCAL_KB = [
            ...
            },
            {
                ...
                answer: `skills canon sekarang duduk dalam Krack, tepatnya ` + "`krack/skills/local-skills/`" + `. kat situ ada skill repo-owned untuk workflow macam builder proxy, website config, nilai islamik, community building, dan lain-lain.\n\nkalau nak cari capability yang sesuai, start situ dulu.`,
                followUp: `kalau pattern kerja dah repeat beberapa kali, kita ikut polisi Krack: propose dulu skill baru bila context dah cukup, lepas tu baru create bila kau confirm.\n\nuntuk startup dan operating doctrine pula, rujuk ` + "`krack/system/IJAM_UNIFIED.md`" + ` dengan ` + "`krack/index/master-krack.md`" + `.`,
