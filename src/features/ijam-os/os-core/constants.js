...
export const LEGACY_STORAGE_KEYS = {
  ...
  installedApps: 'ijamos_installed_apps',
  browserState: 'ijamos_browser_state',
...
export const WORKSPACE_PATHS = {
  ...
  installedApps: `${USER_ROOT}\\Settings\\installed-apps.json`,
  browserState: `${USER_ROOT}\\Settings\\browser-state.json`,
