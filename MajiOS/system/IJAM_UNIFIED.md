...
This file is the canonical IJAM system layer inside `MajiOS/`.
...
```markdown
"As my virtual proxy in KRACKED_OS, help me [task]. Remember the context from MajiOS skills, memory, and previous conversations."
```
