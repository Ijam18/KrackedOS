...
This is the canonical skills index inside `MajiOS/`.
...
-   **MajiOS/system/SkillCreator.md**: Advanced guide for building skills.
...
*File: `MajiOS/skills/local-skills/moon-builder-proxy/SKILL.md`*
