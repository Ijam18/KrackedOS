...
> This MAJI instance now lives inside the broader `MajiOS/` architecture.
>
> Canonical entry sequence:
> `MajiOS/index/master-majios.md` → `MajiOS/core/maji/master-memory.md` → `MajiOS/system/IJAM_UNIFIED.md`
...
- **BMAD Method Engine**: Structured routing, planning, review, and distillation inside MAJI
...
│   │   └── SKILL.md         # Auto-triggered skill (for Skill Plugin System)
│   ├── BMAD-Method-System/  # Structured planning and review engine
│   │   ├── README.md        # Feature overview and command guide
│   │   ├── bmad-core.md     # Precedence rules and routing
│   │   ├── bmad-help-protocol.md # Next-step routing
│   │   ├── bmad-brainstorm-protocol.md # Structured ideation
│   │   ├── bmad-plan-protocol.md # Work planning
│   │   ├── bmad-review-protocol.md # Adversarial review
│   │   ├── bmad-edge-cases-protocol.md # Edge-case hunting
│   │   ├── bmad-distill-protocol.md # Context distillation
│   │   └── kracked-os-phase-guide.md # Phase-aware Kracked_OS guidance
...
bmad help     → Route the best next step
bmad plan     → Build an actionable work plan
